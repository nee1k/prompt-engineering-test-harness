...
def test_root_endpoint_mock():
    ...
    with patch('fastapi.FastAPI') as mock_fastapi:
        ...
        # Test the mock
        assert mock_app.get.return_value == {"message": "Prompt Engineering Test Harness API"}
...
def test_sample_data_fixtures(sample_prompt_system, sample_test_run, sample_regression_set):
