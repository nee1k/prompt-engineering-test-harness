...
def test_create_test_run_success(
    client, test_db, setup_prompt_system, sample_regression_set, mock_openai
):
...
def test_create_test_run_prompt_system_not_found(
    client, test_db, sample_regression_set
):
...
def test_create_test_run_openai_api_error(
    client, test_db, setup_prompt_system, sample_regression_set
):
